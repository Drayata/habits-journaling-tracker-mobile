...
JournalEntry _journalEntryDeserialize(
  ...
  object.id = id;
  object.mood = reader.readLong(offsets[2]);
...
extension JournalEntryByIndex on IsarCollection<JournalEntry> {
  ...
  JournalEntry? getByDateSync(DateTime date) {
  ...
  Future<List<JournalEntry?>> getAllByDate(List<DateTime> dateValues) {
    final values = dateValues.map((e) => [e]).toList();
    return getAllByIndex(r'date', values);
  }

  List<JournalEntry?> getAllByDateSync(List<DateTime> dateValues) {
    final values = dateValues.map((e) => [e]).toList();
  ...
  Future<Id> putByDate(JournalEntry object) {
    return putByIndex(r'date', object);
  }

  Id putByDateSync(JournalEntry object, {bool saveLinks = true}) {
    return putByIndexSync(r'date', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByDate(List<JournalEntry> objects) {
    return putAllByIndex(r'date', objects);
  }

  List<Id> putAllByDateSync(List<JournalEntry> objects,
      {bool saveLinks = true}) {
...
extension JournalEntryQueryWhereSort
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhere> anyContent() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension JournalEntryQueryWhere
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhereClause> contentEqualTo(
      String content) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'content',
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhereClause> contentNotEqualTo(
      String content) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhereClause> contentLessThan(
    String content, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhereClause> contentBetween(
    String lowerContent,
    String upperContent, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhereClause> contentStartsWith(
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhereClause> contentIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'content',
        value: [''],
